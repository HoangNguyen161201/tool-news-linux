...
data_support = [
    {
        "content": "Crocs Classic Clogs, Comfortable shoes for everyday use. Shop now: https://amzn.to/40J3MTE",
    ...
    {
        "content": "Stanley Quencher Tumbler, Keeps your drinks cold for hours. Get yours: https://amzn.to/4l9lrep",
    ...
    {
        "content": "EUHOMY Ice Maker, Make 26lbs of ice per day. Get one now: https://amzn.to/4lUEOt5",
    ...
    {
        "content": "Portable ice maker, makes 26 lbs of ice/day. Perfect for your kitchen or events: https://amzn.to/3GT06YW",
    ...
    {
        "content": "Apple AirPods Pro 2 with active noise cancellation & spatial audio. Check it out: https://amzn.to/45c5MoZ",
    ...
    {
        "content": "Monitor your baby with the DoHonest Baby Car Camera. Safe and easy setup. See more: https://amzn.to/4l9kwL8",
    ...
    {
        "content": "With a vivid 11 display, the Amazon Fire Max 11 is perfect for all day entertainment and productivity: https://amzn.to/4l5n0dk",
    ...
    {
        "content": "Boost productivity with the Anker USB C Hub, featuring 4K HDMI and fast charging: https://amzn.to/4mkCbAq",
    ...
    {
        "content": "Protect your Kindle Paperwhite with this lightweight, water safe cover. Perfect for on the go reading. Check it out: https://amzn.to/3GT0qXE",
    ...
    {
        "content": "Enjoy vibrant sound with the Amazon Echo Dot. A perfect addition to your home for music and Alexa assistance. Check it out: https://amzn.to/4fdeAzj",
    ...
    {
        "content": "Get your day started with the Echo Spot Smart Alarm Clock. Wake up to music, check weather, and more. Check it out: https://amzn.to/4lSOGDs",
    ...
    {
        "content": "Stay focused on reading without distractions with the Amazon Kindle Paperwhite. Perfect for those who need quiet time. Check it out: https://amzn.to/4mlyASO",
    ...
    {
        "content": "Keep an eye on your home or business with the Ring Indoor Cam. Essential for safety and peace of mind. Check it out: https://amzn.to/46AXGbH",
    ...
    {
        "content": "Stay connected with the Apple iPhone 13, offering fast 5G downloads and a cinematic camera. A must have for staying in touch with the world. Check it out: https://amzn.to/45to1HI",
    ...
    {
        "content": "Stay productive with the Apple iPad 7th Gen. 32GB WiFi, perfect for reading news and multitasking. Check it out: https://amzn.to/4l7KsqG",
    ...
    {
        "content": "Track your health and stay connected with the Apple Watch Series 5. Perfect for staying on top of your day. Check it out: https://amzn.to/46BzFkP",
    ...
    {
        "content": "Experience the ultimate noise cancelling with Bose QuietComfort 45. Perfect for focused work or relaxation. Check it out: https://amzn.to/3ISb3KH",
    ...
    {
        "content": "Stay focused on the news—block out noise with Dreamegg D11 Max: https://amzn.to/4fgCfz3",
    ...
    {
        "content": "Block distractions and stay focused on world news with Momcozy: https://amzn.to/3HcCaj5",
    ...
    {
        "content": "Whip up cookies, cakes, and more with ease using the KitchenAid 5 Speed Hand Mixer: https://amzn.to/3UC3DxN",
    ...
    {
        "content": "Stylish 16oz glass cup with bamboo lid & straw—perfect for iced drinks! A great gift idea. Check it out: https://amzn.to/3H0XWGH",
    ...
    {
        "content": "Make gelato, milkshakes, and more with the Ninja CREAMi Ice Cream Maker! Customize your flavors with ease. Check it out: https://amzn.to/3U43wLp",
    ...
    {
        "content": "Keep your car organized and your kids entertained with this backseat organizer. Perfect for long drives. Check it out: https://amzn.to/477TQac",
    ...
    {
        "content": "Stay in shape with these durable neoprene dumbbells. Ideal for home workouts. Check them out: https://amzn.to/3JcQDw3",
    ...
    {
        "content": "Protect your kids with this adjustable bike helmet for safe outdoor fun. Check it out: https://amzn.to/45lKN3c",
    ...
    {
        "content": "Shark Steam Mop Keep your floors clean. Check it out: https://amzn.to/47eUeDM",
    ...
    {
        "content": "Samsung Galaxy Watch 6, Monitor your health while staying connected to breaking news. Check it out: https://amzn.to/4m30nrC",
    ...
    {
        "content": "Ninja Cold Press Juicer, Enjoy fresh juices while keeping up with current events. Check it out: https://amzn.to/4o9LYep",
    ...
    # {
    #     "content": "JBL Flip 5 Speaker, Keep the music flowing. Check it out: https://amzn.to/45c7QNL",
